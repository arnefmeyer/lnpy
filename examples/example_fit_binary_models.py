...
def run_example():
    ...
    models = [CbRF(metric='AUC',
                   prior=prior,
                   **params),
              BernoulliGLM(metric='BernoulliLL',
                           prior=prior,
                           **params)]
